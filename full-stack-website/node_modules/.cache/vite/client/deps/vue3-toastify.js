  ...
  remove(e) {
    if (e) {
      ...
      if (t) {
        ...
        f[t] = n.filter((o) => o.toastId !== e), !f[t].length && !je(t) && oe(t, false), ze(), ie(() => {
...
function lt(e) {
  const t = M(false), n = M(false), a = M(false), o = M(W.Enter), s = $({
    ...e,
...
var ut = Z({
  ...
  setup(e) {
    ...
    }, [v()])]), (e.closeButton === void 0 || e.closeButton === true) && u(Xe, {
      theme: e.theme,
      closeToast: (i) => {
